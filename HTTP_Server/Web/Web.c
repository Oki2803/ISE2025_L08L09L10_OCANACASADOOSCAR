...
/* Last-Modified: Wed, 26 Feb 2025 14:13:38 GMT */
const uint32_t imageLastModified = 1740579218U;

static const uint8_t imageFileData[25839U] = {
...
static const imageFileItem imageFileTable[19U+1U] = {
  ...
  { 0xD1C9C758U, &imageFileData[9659U]  },    // "leds.cgi"
  { 0xCEC97D75U, &imageFileData[11537U] },    // "network.cgi"
  { 0x69E9F01DU, &imageFileData[13685U] },    // "system.cgi"
  { 0x5579E5A7U, &imageFileData[14936U] },    // "tcp.cgi"
  { 0xEEA8CB3DU, &imageFileData[15580U] },    // "xml_http.js"
  { 0xDE703953U, &imageFileData[18396U] },    // "home.png"
  { 0x90CE4E8AU, &imageFileData[19785U] },    // "keil.gif"
  { 0xA35A02C8U, &imageFileData[20923U] },    // "logo.gif"
  { 0x7049A0E1U, &imageFileData[22710U] },    // "llblue.jpg"
  { 0x3BDBDB05U, &imageFileData[25718U] },    // "pabb.gif"
  { 0x00000000U, &imageFileData[25839U] }
};
