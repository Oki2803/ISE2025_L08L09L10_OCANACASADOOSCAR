...
c b 5 <td><input type=checkbox name=led5 OnClick="submit();" %s>MbedRojo</td>
c b 4 <td><input type=checkbox name=led4 OnClick="submit();" %s>MbedVerde</td>
t <td width="5%"></td>
c b 3 <td><input type=checkbox name=led3 OnClick="submit();" %s>MbedAzul</td>
c b 2 <td><input type=checkbox name=led2 OnClick="submit();" %s>Rojo</td>
c b 1 <td><input type=checkbox name=led1 OnClick="submit();" %s>Azul</td>
c b 0 <td><input type=checkbox name=led0 OnClick="submit();" %s>Verde</td>
t </font></table></td></tr>
