...
/* Last-Modified: Tue,    Mar 2025 21:54:13 GMT */
const uint32_t imageLastModified = 1741125253U;

static const uint8_t imageFileData[26805U] = {
...
static const imageFileItem imageFileTable[19U+1U] = {
  ...
  { 0xB0E380D2U, &imageFileData[6936U]  },    // "ad.cgx"
  { 0xF46138EAU, &imageFileData[7060U]  },    // "buttons.cgi"
  { 0xBCB1FE2DU, &imageFileData[8753U]  },    // "buttons.cgx"
  { 0xD7FABA9AU, &imageFileData[8793U]  },    // "language.cgi"
  { 0x6314E402U, &imageFileData[9697U]  },    // "lcd.cgi"
  { 0xD1C9C758U, &imageFileData[10625U] },    // "leds.cgi"
  { 0xCEC97D75U, &imageFileData[12503U] },    // "network.cgi"
  { 0x69E9F01DU, &imageFileData[14651U] },    // "system.cgi"
  { 0x5579E5A7U, &imageFileData[15902U] },    // "tcp.cgi"
  { 0xEEA8CB3DU, &imageFileData[16546U] },    // "xml_http.js"
  { 0xDE703953U, &imageFileData[19362U] },    // "home.png"
  { 0x90CE4E8AU, &imageFileData[20751U] },    // "keil.gif"
  { 0xA35A02C8U, &imageFileData[21889U] },    // "logo.gif"
  { 0x7049A0E1U, &imageFileData[23676U] },    // "llblue.jpg"
  { 0x3BDBDB05U, &imageFileData[26684U] },    // "pabb.gif"
  { 0x00000000U, &imageFileData[26805U] }
};
