...
int Init_ThRTC (void) {
  ...
  LED_Initialize();//Inicializamos los leds para poder usarlo puesto, no usamos el server en el apartado
  startLCD();//Inicializamos el lcd
  cleanBuffer();
...
void RTC_CalendarShow(uint8_t *showtime, uint8_t *showdate){
  ...
  write_lcd((char *)showtime,1);
  
  /* Display date Format : mm-dd-yy */
  sprintf((char *)showdate, "%2d-%2d-%2d", sdatestructureget.Month, sdatestructureget.Date, 2000 + sdatestructureget.Year);
  write_lcd((char *)showdate,2);
